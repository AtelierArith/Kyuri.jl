...
ENV JULIA_PROJECT "@."
WORKDIR /workspace/Kyuri.jl

USER root
RUN chown -R ${NB_UID} /workspace/Kyuri.jl
USER ${USER}

RUN mkdir -p /workspace/Kyuri.jl/src && echo "module Kyuri end" > /workspace/Kyuri.jl/src/Kyuri.jl
COPY ./Project.toml /workspace/Kyuri.jl
